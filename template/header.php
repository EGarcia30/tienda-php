...
<head>
    ...
    <!--CSS-->
    <link rel="stylesheet" href="./src/assets/tools/css/bootstrap.min.css">
    <link rel="stylesheet" href="./src/assets/tools/css/styles.css">
    ...
    <link rel="icon" href="./src/assets/img/logo_size.png">
    <!--SWIPE-->
    <link href="
    ...
    <div class="container__nav">
        <div class="container__navW">
            <div class="navigate">
                <!-- Derecha nombre-->
                <div class="ct__img">
                    <img src="./src/assets/img/logo_size.png" alt="InnoTech" class="img-fit">
                </div>
                ...
                >
                    ...
                    <ul class="nav__links">
                        ...
                        <li class="nav__item">
                            <a href="login/login.html" class="nav__link">Ingresar</a>
                        </li>
                        <li class="nav__item">
                            <a href="registro_clientes/registro_cliente.html" class="nav__link">Registrarse</a>
                        </li>
                    </ul>
            </nav>
            </div>
